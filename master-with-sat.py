...
with open('master-matching.csv', 'rU') as csvfile:
  reader = csv.reader(csvfile)
  row = next(reader)
  writer.writerow( row + ['SAT CR 25th', 'SAT CR 75th', 'SAT M 25th', 'SAT M 75th', 'SAT W 25th', 'SAT W 75th', 'ACT Composite 25th', 'ACT Composite 75th', 'Graduation Rate'])
  for row in reader:
    new_row = row
